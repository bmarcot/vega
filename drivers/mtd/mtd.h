...
struct mtd_info {
	...
	int (*mtd_point)(struct mtd_info *mtd, off_t from, size_t len,
			size_t *retlen, void **virt/* , resource_size_t *phys */); // virt -> at
	int (*mtd_unpoint)(struct mtd_info *mtd, off_t from, size_t len);
	int (*mtd_read)(struct mtd_info *mtd, off_t from, size_t len,
